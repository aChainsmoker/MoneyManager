...
public class DbSeeder
{
    ...
    public void SeedDb()
    {
        ...
        var users = new List<User>
        {
            ...
            new() { Id = Guid.Parse("10000000-0000-0000-0000-000000000002"), Email = "alice.smith@example.com", Name = "Alice Smith", Salt = PasswordHasher.GenerateSalt() },
            new() { Id = Guid.Parse("10000000-0000-0000-0000-000000000003"), Email = "bob.johnson@example.com", Name = "Bob Johnson", Salt = PasswordHasher.GenerateSalt() },
            new() { Id = Guid.Parse("10000000-0000-0000-0000-000000000004"), Email = "charlie.brown@example.com", Name = "Charlie Brown", Salt = PasswordHasher.GenerateSalt() },
            new() { Id = Guid.Parse("10000000-0000-0000-0000-000000000005"), Email = "david.wilson@example.com", Name = "David Wilson", Salt = PasswordHasher.GenerateSalt() },
            new() { Id = Guid.Parse("10000000-0000-0000-0000-000000000006"), Email = "emma.davis@example.com", Name = "Emma Davis", Salt = PasswordHasher.GenerateSalt() }
        };
        ...
        var categories = new List<Category>
        {
            ...
            new() { Id = Guid.Parse("10000000-0000-0000-0000-000000000104"), Name = "Public Transport", Type = CategoryType.Expense, ParentId = Guid.Parse("10000000-0000-0000-0000-000000000002") },
